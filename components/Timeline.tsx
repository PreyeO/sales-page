            ...
            <div className="max-w-4xl mx-auto text-center">
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-8 relative">
                    ...
                    >
                        ...
                        <h3 className="text-2xl font-bold mb-2 text-gray-900">Send Details</h3>
                        <p className="text-gray-600">You send us your content and basic details.</p>
                    </motion.div>
                    ...
                    >
                        ...
                        <h3 className="text-2xl font-bold mb-2 text-gray-900">Live Website</h3>
                        <p className="text-gray-600">Your site is ready, live, and working perfectly.</p>
                    </motion.div>
                </div>
