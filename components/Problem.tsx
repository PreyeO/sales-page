...
import { Search, XCircle, UserX, CheckCircle2 } from "lucide-react";
...
export default function Problem() {
  ...
  return (
    <section className="lg:py-20 py-10 px-6 bg-gray-50 border-y border-gray-100">
      <div className="max-w-4xl mx-auto text-center space-y-12">
        ...
        <motion.div
          ...
          className="hidden  bg-blue-50 border border-blue-100 p-4 rounded-xl lg:inline-block"
        >
