...
export default function Solution() {
  const benefits = [
    {
      icon: Smartphone,
      title: "One-two-page mobile-friendly website",
  ...
  return (
    <section className="lg:py-24 py-10 px-6 bg-white relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-16">
          ...
          >
            What you get in the{" "}
            <span className="text-blue-600">2-Day Setup</span>
          </motion.h2>
          <motion.div
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {benefits.map((item, index) => (
            <motion.div
              ...
              className="group lg:p-8 p-4 bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-xl hover:border-blue-100 transition-all duration-300"
            >
