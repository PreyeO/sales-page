...
export default function Testimonials() {
    const testimonials = [
        {
            quote: "I finally had a proper link to send customers. It made my business look serious.",
            author: "Vendor",
        },
        {
            quote: "The process was fast and stress-free. I didn’t need to understand anything technical.",
            author: "Coach",
        },
        {
